...
#ifndef DISCOMBOBULATOR_LASTFM_SECRET_H
#define DISCOMBOBULATOR_LASTFM_SECRET_H
...
{
  inline std::string GetSecretLastfmSecretUTF8()
  {
    #error "Your discombobulated secret would go here, otherwise you can just remove this line and return an empty string if you don't want last.fm support"
    return "";
  }
}

#endif // DISCOMBOBULATOR_LASTFM_SECRET_H
